...
// import 'a_theme.dart';
import 'tk_theme.dart';

//You can't exclude this file from the dart formatter because the Flutter team has not implemented this feature yet -_-
class TkColor {
  //Exceptions
  static final Exception _themekitWidgetException = Exception("Theme Kit ERROR: ThemeKit widget not created. Please wrap your app with the ThemeKit widget. Check Theme Kit docs for more info.");
  static final Exception _colorNullException = Exception("Theme Kit ERROR: Color cannot be null.");

  //ThemeKit semantic colors
  ...
  static void setTheme(TkTheme theme) {
