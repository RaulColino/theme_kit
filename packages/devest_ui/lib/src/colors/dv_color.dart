...
class DvColor {
  //Exceptions
  static final Exception _themekitWidgetException = Exception("Theme Kit ERROR: DevestUi widget not created. Please wrap your app with the DevestUi widget. Check Theme Kit docs for more info.");
  static final Exception _colorNullException = Exception("Theme Kit ERROR: Color cannot be null.");

  //DevestUi semantic colors
  ...
  static void setTheme(DvTheme theme) {
